...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.3.6 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/dynamodb v1.12.0 // indirect
